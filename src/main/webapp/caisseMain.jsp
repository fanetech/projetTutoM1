    ...
    <div class="flex flex-row justify-center w-100">
        ...
        <div class="content my-8 mx-3">
            ...
            <table>
                ...
                <tbody>
                <%
                    List<Caisse> mvmtCaisseList = (List<Caisse>) request.getAttribute("caisse");
                    if (mvmtCaisseList != null) {
                        for (Caisse mvmtCaisse : mvmtCaisseList) {
                %>
                <tr>
                    ...
                    <td class="py-3 text-sm flex flex-column justify-content-center" role="cell">
                        <a href="/editCaisse-servlet/<%= mvmtCaisse.getId() %>" class="mr-1" >
                        ...
                        <a href="/delete-servlet/caisse/<%= mvmtCaisse.getId() %>"  class="me-1">
